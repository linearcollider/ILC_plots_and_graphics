...
#endif
void powerlumi_vs_linE()
{
//=========Macro generated from canvas: c1/
//=========  (Thu Oct 10 17:08:45 2024) by ROOT version 6.32.02
   TCanvas *c1 = new TCanvas("c1", "",0,66,1024,768);
   gStyle->SetOptStat(0);
   c1->Range(-0.2493333,-1.111286,1.217333,3.084869);
   c1->SetFillColor(10);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetLogy();
   ...
   Double_t Graph0_fy1[4] = { 0.787234, 6.175, 27.3, 142.8 };
   ...
   Graph_Graph01->SetMinimum(0.4);
   Graph_Graph01->SetMaximum(750);
   ...
   Double_t Graph1_fy2[4] = { 0.4630788, 3.632353, 16.05882, 84 };
   ...
   Graph_Graph12->SetMinimum(0.416771);
   Graph_Graph12->SetMaximum(92.35369);
   ...
   Double_t Graph2_fy3[4] = { 1.304348, 9.375, 30, 300 };
   ...
   Graph_Graph23->SetMinimum(1.173913);
   Graph_Graph23->SetMaximum(329.8696);
   ...
   Double_t Graph3_fy4[4] = { 0.9114583, 6.578947, 21.08434, 218.75 };
   ...
   Graph_Graph34->SetMinimum(0.8203125);
   Graph_Graph34->SetMaximum(240.5339);
   ...
   Double_t Graph4_fy5[4] = { 277.7778, 47.82609, 98.37838, 99.83051 };
   ...
   Graph_Graph45->SetMinimum(24.83092);
   Graph_Graph45->SetMaximum(300.7729);
   ...
   Double_t Graph5_fy6[4] = { 277.7778, 36.95652, 98.37838, 99.83051 };
   ...
   Graph_Graph56->SetMinimum(12.8744);
   Graph_Graph56->SetMaximum(301.8599);
   ...
   Double_t Graph6_fy7[4] = { 447.619, 82.22222, 96.11111, 83.33333 };
   ...
   Graph_Graph67->SetMinimum(45.68254);
   Graph_Graph67->SetMaximum(484.1587);
   ...
   Double_t Graph7_fy8[4] = { 280.4878, 51.11111, 59.72222, 58.82353 };
   ...
   Graph_Graph78->SetMinimum(28.17344);
   Graph_Graph78->SetMaximum(303.4255);
   ...
   Double_t Graph8_fy9[4] = { 280.4878, 36.66667, 59.72222, 58.82353 };
   ...
   Graph_Graph89->SetMinimum(12.28455);
   Graph_Graph89->SetMaximum(304.8699);
