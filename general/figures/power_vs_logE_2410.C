...
//=========  (Thu Oct 10 16:59:08 2024) by ROOT version 6.32.02
   TCanvas *c1 = new TCanvas("c1", "",0,66,1024,768);
   gStyle->SetOptStat(0);
   c1->Range(-1.553147,-152.5641,0.7894693,744.8718);
   c1->SetFillColor(10);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetLogx();
   ...
   Double_t Graph0_fy1[4] = { 222, 247, 273, 357 };
   ...
   Graph_Graph01->GetYaxis()->SetTitle("Total AC Power [MW]");
   ...
   Double_t Graph1_fy2[4] = { 222, 247, 273, 357 };
   ...
   Graph_Graph12->SetMinimum(208.5);
   Graph_Graph12->SetMaximum(370.5);
   ...
   Double_t Graph2_fy3[4] = { 300, 300, 300, 300 };
   ...
   Graph_Graph23->SetMinimum(299.9);
   Graph_Graph23->SetMaximum(301.1);
   ...
   Double_t Graph3_fy4[4] = { 350, 350, 350, 350 };
   ...
   Graph_Graph34->SetMinimum(349.9);
   Graph_Graph34->SetMaximum(351.1);
   ...
   Double_t Graph4_fy5[4] = { 100, 110, 364, 589 };
   ...
   Graph_Graph45->SetMinimum(51.1);
   Graph_Graph45->SetMaximum(637.9);
   ...
   Double_t Graph5_fy6[4] = { 100, 170, 364, 589 };
   ...
   Graph_Graph56->SetMinimum(51.1);
   Graph_Graph56->SetMaximum(637.9);
   ...
   Double_t Graph6_fy7[4] = { 94, 111, 173, 300 };
   ...
   Graph_Graph67->SetMinimum(73.4);
   Graph_Graph67->SetMaximum(320.6);
   ...
   Double_t Graph7_fy8[4] = { 115, 138, 215, 300 };
   ...
   Graph_Graph78->SetMinimum(96.5);
   Graph_Graph78->SetMaximum(318.5);
   ...
   Double_t Graph8_fy9[4] = { 115, 198, 215, 300 };
   ...
   Graph_Graph89->SetMinimum(96.5);
   Graph_Graph89->SetMaximum(318.5);
